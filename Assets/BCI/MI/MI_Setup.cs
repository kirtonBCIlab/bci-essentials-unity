...
public class MI_Setup : MonoBehaviour
{
    ...
    [SerializeField] MI_Controller MI_Controller;
    ...
    private void Awake()
    {
        ...
        MI_Controller = GetComponent<MI_Controller>();
    }
    private void Start()
    {
        //Get all of the information from the MI_Controller that is needed here.
    ...
    public GameObject[,] SetUpMatrix(List<GameObject> objectList)
    {
        ...
        */
        ...
        int numColumns = MI_Controller.numColumns;
        int numRows = MI_Controller.numRows;
        GameObject myObject = MI_Controller.myObject;
        double startX = MI_Controller.startX;       //Initial position of X for drawing in the objects
        double startY = MI_Controller.startY;       //Initial position of Y for drawing in the objects
        float startZ = MI_Controller.startZ;        //Initial position of Z for drawing in the objects
        double distanceX = MI_Controller.distanceX;    //Distance between objects in X-plane
        double distanceY = MI_Controller.distanceY;
        ...
        MI_Controller.objectList = objectList;
