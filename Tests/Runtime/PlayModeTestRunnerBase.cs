...
namespace BCIEssentials.Tests.Utilities
{
    ...
    public class PlayModeTestRunnerBase
    {
        ...
        protected static SPO AddSPOToScene(string tag = "Player", bool includeMe = true)
        {
            return AddSPOToScene<SPO>(tag, includeMe);
        }

        protected static T AddSPOToScene<T>(string tag = "Player", bool includeMe = true) where T : SPO
        {
